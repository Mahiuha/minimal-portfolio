...
function Intro() {
    return (
        <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
            ...
            <p className="text-sm max-w-2xl mb-3 font-bold">A little bit of myself, I'm from Kenya, you can find me online as <a href="https://mahiuha.com" target="_blank" className="text-cyan-500 hover:underline underline-offset-2 decoration-2" rel="noopener">@mahiuha</a>, my experience is in Web Development and I enjoy working in projects related to Back-end</p>
