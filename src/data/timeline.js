export default [
    ...
    },
    {
        ...
        details: 'I wrote my first line of code using Assembly to make the popular hello world and it seems so simple but at the same time so awesome to give some instruction to the computer and see it printed on the screen, and then it begin my curiosity and passion for programming and things related to technology.',
    },
]